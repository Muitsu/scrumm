...
class TabletHomeBody extends StatefulWidget {
  const TabletHomeBody({super.key});

  @override
  State<TabletHomeBody> createState() => _TabletHomeBodyState();
}

class _TabletHomeBodyState extends State<TabletHomeBody> {
                ...
                child: Row(
                  children: [
                    SizedBox(
                        ...
                        child: const HomeDrawer(isTablet: true)),
                    VerticalDivider(
